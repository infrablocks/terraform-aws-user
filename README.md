...
[![CircleCI](https://circleci.com/gh/infrablocks/terraform-aws-user.svg?style=svg)](https://circleci.com/gh/infrablocks/terraform-aws-user)

A Terraform module for managing a AWS IAM user.
