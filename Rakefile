...
namespace :keys do
  ...
  namespace :secrets do
    namespace :gpg do
      RakeGPG.define_generate_key_task(
        ...
        owner_comment: 'terraform-aws-user CI Key'
      )
    end
  ...
  namespace :user do
    namespace :directory do
      desc 'Ensure user secrets directory exists'
      task :ensure do
    ...
    namespace :passphrase do
      ...
      task generate: %w[directory:ensure] do
    ...
    namespace :gpg do
      RakeGPG.define_generate_key_task(
        output_directory: 'config/secrets/user',
        name_prefix: 'gpg',
        armor: false,
        owner_name: 'InfraBlocks Maintainers',
        owner_email: 'maintainers@infrablocks.io',
        owner_comment: 'terraform-aws-user User Key'
      ) do |t|
        t.passphrase =
...
RakeCircleCI.define_project_tasks(
  namespace: :circle_ci,
  project_slug: 'github/infrablocks/terraform-aws-user'
) do |t|
  circle_ci_config =
...
RakeGithub.define_repository_tasks(
  namespace: :github,
  repository: 'infrablocks/terraform-aws-user'
) do |t, args|
  github_config =
